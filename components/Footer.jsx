...
const Footer = () => {
  return (
    <div>
      <footer className="flex flex-col text-gray-500 shadow-lg border-t-2 sticky bottom-0 mt-4">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            ...
            <p className="mt-2 px-4 text-sm text-gray-500">
              Wear the &lt;code/&gt; <br /> Premium coding t-shirts, hoodies and
              apparels
            </p>
          </div>
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                  <Link legacyBehavior href={"/hoodies"}>
                    <a className="text-gray-500 hover:text-gray-800">Hoodies</a>
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link legacyBehavior href={"/mugs"}>
                    <a className="text-gray-500 hover:text-gray-800">Mugs</a>
                  </Link>
                </li>
              </nav>
            </div>
