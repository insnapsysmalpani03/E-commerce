  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Codeswear.com - Wear the Code"></meta>
      </Head>
      <div className="w-full">
        <img src="/banner1.png" alt="" width={5000} />
      </div>
      <section className="text-gray-600 body-font">
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Wear Your Code, Show Your Passion</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500"> CodesWear turns coding into style. From comfortable hoodies to unique tees, express your tech passion wherever you go. It's more than just apparel—it's a way to stand out, to live the coder's lifestyle. Join the movement, wear the code.</p>
    </div>
